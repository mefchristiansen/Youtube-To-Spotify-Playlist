...
def set_up_youtube_secrets():
    ...
    youtube_prefix = '/YoutubeToSpotify/Prod/Youtube'

    for key, value in youtube_secrets.items():
        write_parameter(youtube_prefix, key, value)
...
def set_up_spotify_secrets():
    ...
    spotify_prefix = '/YoutubeToSpotify/Prod/Spotify'

    for key, value in spotify_secrets.items():
        write_parameter(spotify_prefix, key, value)
